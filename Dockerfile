...
CMD bitcoind -datadir=/bitcoin -server=1 -rest=1 -disablewallet -rpcbind=bitcoin -rpcallowip=172.16.0.0/12 -rpcallowip=10.0.0.0/24 -rpcuser=$USER -rpcpassword=$PASS ${PARAMS}
